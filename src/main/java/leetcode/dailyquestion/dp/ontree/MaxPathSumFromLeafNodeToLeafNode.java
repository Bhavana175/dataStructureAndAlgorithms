...
public class MaxPathSumFromLeafNodeToLeafNode {
    public static void main(String[] args) {
        ...
        System.out.println(findMaxSumFromLeafNodeToLeafNode(t1));
    }

    private static int findMaxSumFromLeafNodeToLeafNode(TreeNode root) {
    ...
    private static int findMaxPathSum(TreeNode root, int[] sum) {
        ...
        int maxSumForCurrNodeOneBranch =root.val+ Math.max(left, right);
